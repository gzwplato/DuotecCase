...
procedure TControllerTabelaSistema.ModelTabelaSistema : IModelTabelaSistema;
  AValue: IModelTabelaSistema);
begin
  if FModelTabelaSistema=AValue then Exit;
  FModelTabelaSistema:=AValue;
end;
